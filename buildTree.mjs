...
async function buildTree(sourcePath, destinationPath) {
  const unsortedNodes = JSON.parse(
   ...
   * The last node is the node that is not the previous sibling of any other node
   *
   ...
   */
  Object.keys(references).forEach((nodeId) => {
    ...
    if (nodeMeta.isLastNode) {
      ...
      // and "rootTreeIsSorted" when necessary
